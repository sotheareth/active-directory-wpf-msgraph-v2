...
namespace active_directory_wpf_msgraph_v2
{
    ...
    public partial class MainWindow : Window
    {
        ...
        string[] scopes = new string[] { "User.Read", "Files.ReadWrite.All", "Files.ReadWrite.AppFolder" };
        ...
        private async void ReadFile_Click(object sender, RoutedEventArgs e)
        {
            ...
            var url = "https://graph.microsoft.com/v1.0/me/drive/root:/test/app1.txt:/content";
            var fullFileName = "app1.txt";
            var client = new Client(accessToken);
            var result = await client.UploadFile(url, fullFileName);
